...
/*
IdleReport names the defenders worth looking at, and says nothing when there are
none.

The threshold is a share of the run rather than a count of seconds: a bot idle
for a moment between actions is normal, and one idle for a third of a wave has
been handed nothing. Peppy's stalled sniper was at 1.00.
*/
