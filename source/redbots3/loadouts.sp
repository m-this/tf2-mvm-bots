...
public const int WEAPONS_SCOUT_MELEE[] = {TF_ITEMDEF_DEFAULT, 190, 44, 221, 264, 317, 325, 349, 355, 423, 450, 452, 474, 572, 648, 660, 880, 939, 954, 999, 1013, 1071, 1123, 1127, 1202, 30667, 30758};
public const int WEAPONS_SOLDIER_PRIMARY[] = {TF_ITEMDEF_DEFAULT, 205, 127, 228, 414, 441, 513, 658, 730, 800, 809, 889, 898, 907, 916, 965, 974, 1085, 1104, 15006, 15014, 15028, 15043, 15052, 15057, 15081, 15104, 15105, 15129, 15130, 15150};
...
public const int WEAPONS_HEAVY_PRIMARY[] = {TF_ITEMDEF_DEFAULT, 202, 41, 298, 312, 424, 654, 793, 802, 811, 832, 850, 882, 891, 900, 909, 958, 967, 1206, 15004, 15020, 15026, 15031, 15040, 15055, 15086, 15087, 15088, 15098, 15099, 15123, 15124, 15125, 15147};
...
public const int WEAPONS_ENGINEER_SECONDARY[] = {TF_ITEMDEF_DEFAULT, 209, 140, 160, 294, 528, 1086, 1202, 15013, 15018, 15035, 15041, 15046, 15056, 15060, 15061, 15100, 15101, 15102, 15126, 15148, 30666, 30668};
...
public const int WEAPONS_SPY_PDA2[] = {TF_ITEMDEF_DEFAULT, 212, 59, 60, 297, 947, 1205};
